...
enum EPD_CMDS {
    ...
    // 控台模式数据命令
    EPD_CMD_DASHBOARD_COUNTDOWN = 0x40, /**< set dashboard countdown */
    EPD_CMD_DASHBOARD_MESSAGE = 0x41,   /**< set dashboard message */
    EPD_CMD_DASHBOARD_GOAL = 0x42,      /**< set dashboard goal */
